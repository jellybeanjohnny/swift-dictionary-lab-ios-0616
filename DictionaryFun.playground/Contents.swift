...
let state = "New York"
// write your code here
if let newYorkCapital = statesAndCapitals[state] {
	print("The capital of \(state) is \(newYorkCapital)")
}
 ...
 */
// dictionary of strings and arrays
...
if let band = bandDictionary[bandName] {
	print(band)
}
